...
#        first_data = first_data[(first_data['sales_surprise_x'].notnull())&(first_data['sales_surprise'].notnull())]
...
#        
        ...
        for i in factor2:
            ...
            locals()['q_{}'.format(i)] = locals()['q_{}'.format(i)][(locals()['q_{}'.format(i)]['sales_surprise_x'].notnull())&(locals()['q_{}'.format(i)]['sales_surprise'].notnull())]
            locals()['q_{}'.format(i)]['sales_surprise'] = locals()['q_{}'.format(i)]['sales_surprise_x'] + locals()['q_{}'.format(i)]['sales_surprise']
