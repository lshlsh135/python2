# -*- coding: utf-8 -*-
"""
Created on Wed Dec 12 13:08:49 2018
...
#                first_data = first_data[first_data['MARKET_CAP_COM']>100000000000]
                ...
                first_data = first_data.assign(factor_z_score=np.nansum(first_data.loc[:,[factor2+'_y'  for factor2 in factor2]],axis=1))
                
                first_data = first_data[first_data['factor_z_score'].notnull()]
                first_data = first_data.assign(rnk = first_data.loc[:,'factor_z_score'].rank(method='first',ascending = False))
                ...
                for i in range(1,2):
                    ...
                    rst_rtn_d.loc[(rst_rtn_d['TRD_DATE_y']==rst_rtn_d.loc[0,'TRD_DATE_y'])&(rst_rtn_d['GICODE']!='A005930'),'rtn_d'] = locals()['end_wealth_{}'.format(i)]  * (1-samsung_float_weights)/stock_num
